...
API: ExchangeRate-API for real-time currency data.
...
Go to ExchangeRate-API and sign up for a free API key.
...
This project was created as a personal project to practice working with APIs and DOM manipulation using Vanilla JavaScript.
